...
from Yeah_Rec.data import load_rating_data, load_triple_data, load_kg_rating_data

import Yeah_Rec.models.transUP as transup
import Yeah_Rec.models.transH as transh
import Yeah_Rec.models.yeah as jtransup

def get_flags():
    gflags.DEFINE_enum("model_type", "yeah", ["yeah"], "")
    ...
    gflags.DEFINE_integer("batch_size", 256, "Minibatch size.")
    ...
    gflags.DEFINE_string("load_experiment_name", "", "")
...
def flag_defaults(FLAGS):
    ...
    if FLAGS.model_type in ['cke', 'jtransup','yeah']:
